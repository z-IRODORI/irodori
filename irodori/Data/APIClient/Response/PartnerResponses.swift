...
struct PartnerAdvice: Decodable, Hashable, Identifiable {
    ...
    static func mock() -> PartnerAdvice {
        PartnerAdvice(
            id: "advice-mock-1",
            understanding: "ここだけの話。あなたの「カジュアル」率、12回中7回。私しか知らない数字。",
            advice: "もうひとつ内緒の話——小物だけきれいめを一点足すと、たぶん化ける。今度の休日、試して。",
            discovery: "打ち明けると——あなたの目は「きれいめ」を追うのに、手は「カジュアル」を取る。次はどっちの味方をする？",
