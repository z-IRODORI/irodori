...
struct CoordinateReview: Decodable, Identifiable {
    var id: Int
    let coordinate_review: String

    // TODO: 01~03 をリストで管理
    let coordinate_item01: String
    let recommend_item01: String
    let recommend_item01_url: String

    let coordinate_item02: String
    let recommend_item02: String
    let recommend_item02_url: String

    let coordinate_item03: String
    let recommend_item03: String
    let recommend_item03_url: String
}
...
extension CoordinateReview {
    static func mock() -> Self {
        ...
        return .init(
            ...
            coordinate_item01: "", recommend_item01: "", recommend_item01_url: "",
            coordinate_item02: "", recommend_item02: "", recommend_item02_url: "",
            coordinate_item03: "", recommend_item03: "", recommend_item03_url: ""
        )
    }
}
